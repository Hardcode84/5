...
//
// RUN: hc-opt %s --hc-lower-launch-scalar-ops --hc-lower-launch-shaped-constants --hc-lower-launch-body --hc-reconcile-generic-operands --reconcile-unrealized-casts | FileCheck %s
