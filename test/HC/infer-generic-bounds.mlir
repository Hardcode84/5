...
// CHECK: %[[M_BOUND:.+]] = hc.materialize_bound_expr : !hc.idx<"M">
// CHECK: %[[N_BOUND:.+]] = hc.materialize_bound_expr : !hc.idx<"N">
// CHECK: hc.generic
...
// CHECK: %[[M_BOUND:.+]] = hc.materialize_bound_expr : !hc.idx<"M">
// CHECK: %[[N_BOUND:.+]] = hc.materialize_bound_expr : !hc.idx<"N">
// CHECK: %[[K_BOUND:.+]] = hc.materialize_bound_expr : !hc.idx<"K">
// CHECK: hc.generic
...
// Fully concrete already: pass is a no-op, no `hc.materialize_bound_expr`
