...
// CHECK: hc.load %[[A]][%[[A_ROW]], %[[K_SLICE]]] {shape = #hc.shape<["16", "16"]>} : (!hc.undef, !hc.undef, !hc.undef) -> !hc.undef
// CHECK: %[[B_COL:[^ ]+]] = hc.slice_expr
// CHECK: hc.load %[[B]][%[[K_SLICE]], %[[B_COL]]] {shape = #hc.shape<["16", "16"]>} : (!hc.undef, !hc.undef, !hc.undef) -> !hc.undef
